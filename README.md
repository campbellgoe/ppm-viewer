# PPM viewer
This project was set up with create-next-app. It takes a ppm file as input and renders it to a canvas file. It doesn't work on all input, e.g. it doesn't collapse whitespace yet.
